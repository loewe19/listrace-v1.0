<?php
$passer = array(
    "apikey" => "120958124665da02ca099253.94719736", // Enrer votre apikey
    "site_id" => "5868994", //Entrer votre site_ID
    "secret_key" => "105728279065da0335952467.87262355" //Entrer votre clé secret
);
...
if (isset($_POST['cpm_trans_id'])) {
    ...
    try {
        ...
        require_once __DIR__ . '/../passer.php';
