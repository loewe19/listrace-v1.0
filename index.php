...
<html class="no-js" lang="fr">
    ...
    <head>
        ...
        <title>illiminaty location</title>
					...
					<div class="welcome-hero-form">
						...
						<div class="single-welcome-hero-form">
							...
							<form action="index.html">
								...
								<input type="text" placeholder="Ex: new bell,bonamoussadi, village,bonapriso" />
					...
					<ul>
						...
						<li>
							...
							<div class="single-list-topics-content">
								...
								<p>
			<img src="photo0jpg.jpg" class="imageflottante"alt="imageflottante" font-size:30px >
      <img src="Restaurant.jpg"alt="restaurant">
      <img src="louix_louis.jpg"alt="louix_louis">
	</p>
						...
						<li>
							...
							<div class="single-list-topics-content">
								...
								<img src="exterior.jpg"alt="exterior">
		           	...
		           	<div class="row">
			           	...
			           	<div class="col-sm-9">
			           		...
			           		<ul class="footer-menu-item">
			                    ...
			                    <li class="scroll"><a href="#blog">blog</a></li>
<li
class="scroll"><a href="#op.html">op</a></li>
